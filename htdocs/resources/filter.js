/*==================================================*
 ...
 Modified 2013 Christopher Gutteridge
...
function filterlist(selectobjid, matchref) {
  ...
  this.set = function(pattern) {
    ...
    for( key in this.matchref ) {
      var thing = document.getElementById( key );
if( !thing ) { alert( "error: key="+key ); return; }
      if( regexp.test( this.matchref[key] ) )
      {
